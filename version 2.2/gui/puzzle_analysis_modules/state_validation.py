...
class State_Validator():
    ...
    def validate_state(self, state):
        ...
        for pieces_perm in pieces_perms:
            perms += self._find_piece_permutation(state, pieces_perm, piece_lists)
    ...
    def _find_pieces_permutation(self, state, piece_dicts):
        ...
        2. if so, determine all possible permutations
        """
        perms = [[]]
    ...
    def _find_piece_permutation(self, state, pieces_perm, piece_lists):
        """
        convert a permutation of the pieces into the actual permutation
        """
        perms = [dict()]
