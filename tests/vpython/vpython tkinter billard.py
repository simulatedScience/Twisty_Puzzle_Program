...
for x in range(0,16):
	...
	# ballTex[x] = vpy.texture(data=ballImage[x], mapping="rectangular")

#Simulation stuff
def drawTable():
	global f1
	global f2
	table = box(pos=(0,0,0), length=12.63, height=0.2, width=24.3, color=color.green)
	...
	sidingLeft = box(pos=(-5.815,0.5,0), length=1, height=1, width=24.30)
	sidingRight = box(pos=(5.815,0.5,0), length=1, height=1, width=24.30)
	sidingBottom = box(pos=(0,0.5,11.65), length=12.63, height=1, width=1)
	sidingTop = box(pos=(0,0.5,-11.65), length=12.63, height=1, width=1)
	#0.203 ft is r of cueball
	cueball = sphere(pos = (0,0.4,-8), radius=0.234375, zCheck=False, xCheck=False, name="cueball")
	collision = [None]*15
	collision[0] = sphere(pos = (0,0.4,5), radius=0.234375, zCheck=False, xCheck=False, name="collision")
	collision[1] = sphere(pos = (0.5,0.4,5), radius=0.234375, zCheck=False, xCheck=False, name="collision2")
	collision[2] = sphere(pos = (1,0.4,5), radius=0.234375, zCheck=False, xCheck=False, name="collision3")
	collision[3] = sphere(pos = (-0.5,0.4,5), radius=0.234375, zCheck=False, xCheck=False, name="collision4")
	collision[4] = sphere(pos = (-1,0.4,5), radius=0.234375, zCheck=False, xCheck=False, name="collision5")
	collision[5] = sphere(pos = (0.25,0.4,4.5), radius=0.234375, zCheck=False, xCheck=False, name="collision6")
	collision[6] = sphere(pos = (-0.25,0.4,4.5), radius=0.234375, zCheck=False, xCheck=False, name="collision7")
	collision[7] = sphere(pos = (0.75,0.4,4.5), radius=0.234375, zCheck=False, xCheck=False, name="collision8")
	collision[8] = sphere(pos = (-0.75,0.4,4.5), radius=0.234375, zCheck=False, xCheck=False, name="collision9")
	collision[9] = sphere(pos = (-0.5,0.4,4), radius=0.234375, zCheck=False, xCheck=False, name="collision10")
	collision[10] = sphere(pos = (0,0.4,4), radius=0.234375, zCheck=False, xCheck=False, name="collision11")
	collision[11] = sphere(pos = (0.5,0.4,4), radius=0.234375, zCheck=False, xCheck=False, name="collision12")
	collision[12] = sphere(pos = (0.25,0.4,3.5), radius=0.234375, zCheck=False, xCheck=False, name="collision13")
	collision[13] = sphere(pos = (-0.25,0.4,3.5), radius=0.234375, zCheck=False, xCheck=False, name="collision14")
	collision[14] = sphere(pos = (-0,0.4,3), radius=0.234375, zCheck=False, xCheck=False, name="collision15")
...
label1 = tk.Label(app, textvariable=labelText, font="bold",height=4)
label1.grid(row = 0, column = 0, padx=(10, 0), columnspan = 2)

#mass label
labelText=StringVar()
labelText.set("Mass of Balls (Kg): ")
labelMass=tk.Label(app, textvariable=labelText, height=4)
labelMass.grid(row = 1, column = 0)

#textview for mass
mass=StringVar(None)
massname=tk.Entry(app,textvariable=mass,width=10)
massname.grid(row = 1, column = 1)

#label for force
labelText=StringVar()
labelText.set("Initial Force (N): ")
labelForce=tk.Label(app, textvariable=labelText, height=4)
labelForce.grid(row = 2, column = 0)

#textview for force
force=StringVar(None)
forcename=tk.Entry(app,textvariable=force,width=10)
forcename.grid(row = 2, column = 1)

#label for gravity
labelText=StringVar()
labelText.set("Gravity (m/(s*s)): ")
labelGrav=tk.Label(app, textvariable=labelText, height=4)
labelGrav.grid(row = 3, column = 0)

#textview for gravity
grav=StringVar(None)
gravname=tk.Entry(app,textvariable=grav,width=10)
gravname.grid(row = 3, column = 1)

#label for friction
labelText=StringVar()
labelText.set("Table Friction Coefficient (~ 0.2): ")
labelFriction=tk.Label(app, textvariable=labelText, height=4)
labelFriction.grid(row = 4, column = 0)

#textview for friction
friction=StringVar(None)
frictionname=tk.Entry(app,textvariable=friction,width=10)
frictionname.grid(row = 4, column = 1)

#label for shot angle
labelText=StringVar()
labelText.set("Shot Angle (Degrees): ")
labelAngle=tk.Label(app, textvariable=labelText, height=4)
labelAngle.grid(row = 5, column = 0)

#textview for friction
angle=StringVar(None)
anglename=tk.Entry(app,textvariable=angle,width=10)
anglename.grid(row = 5, column = 1)

#start simulation button
start = tk.Button(app, text="Start Simulation", width=17, command=startSimulation)
start.grid(row = 6, column = 0, padx=(10,0))

#stop simulation button
stop = tk.Button(app, text="Stop Simulation", width=17, command=stopSimulation)
