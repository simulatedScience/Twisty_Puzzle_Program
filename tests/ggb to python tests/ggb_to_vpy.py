...
import ggb_to_python as ggb_py
import xml_point_info as xml_point
...
def _vec(args):
    """
    return a vpython vector with the given arguments
    """
    return vpy.vector(*args)
...
def draw_point(point_dict, radius=None):
    ...
    vpy.sphere(pos=point_dict["coords"],
...
def draw_cones(point_dicts, PUZZLE_COM=vpy.vec(0,0,0)):
    ...
    """
    for point_dict in point_dicts:
        draw_cone(point_dict, PUZZLE_COM=PUZZLE_COM)
